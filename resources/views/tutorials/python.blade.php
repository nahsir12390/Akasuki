...
@section('title', 'Python Tutorials - Learn Programming Fundamentals')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            <div class="inline-flex items-center justify-center w-16 h-16 bg-blue-100 dark:bg-blue-900 rounded-full mb-4">
                <i class="fab fa-python text-3xl text-blue-600 dark:text-blue-400"></i>
            </div>
            <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">
                Python Tutorials
            </h1>
            <p class="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Master Python - the versatile programming language loved by beginners and professionals alike. 
                Learn everything from basic syntax to advanced concepts for web development, data science, and automation.
            </p>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm border border-gray-100 dark:border-gray-700">
                <div class="text-2xl font-bold text-yellow-600 dark:text-yellow-400 mb-2">Free</div>
                <div class="text-sm text-gray-600 dark:text-gray-400">No Cost</div>
            </div>
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm border border-gray-100 dark:border-gray-700">
                <div class="text-2xl font-bold text-red-600 dark:text-red-400 mb-2">Versatile</div>
                <div class="text-sm text-gray-600 dark:text-gray-400">Multiple Domains</div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 mb-12">
            <div class="text-center max-w-3xl mx-auto">
                ...
                <p class="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                    Write, run, and test Python code directly in your browser with these interactive coding platforms.
                </p>
                    ...
                    <a href="https://colab.research.google.com/" target="_blank" rel="noopener noreferrer"
                       class="group bg-gradient-to-r from-yellow-600 to-yellow-700 text-white p-6 rounded-xl hover:from-yellow-700 hover:to-yellow-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div class="text-center">
                            ...
                            <h3 class="font-semibold text-lg mb-2">Colab</h3>
                            <p class="text-yellow-100 text-sm opacity-90">Data Science</p>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="bg-gradient-to-r from-blue-600 to-green-600 rounded-2xl p-8 text-white mb-12">
            <div class="text-center max-w-3xl mx-auto">
                <h2 class="text-3xl font-bold mb-4">Explore Python Specializations</h2>
                <p class="text-blue-100 text-lg mb-8">
                    Python opens doors to various domains - choose your path and specialize.
                </p>
