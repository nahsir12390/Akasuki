...
@section('title', 'PHP Tutorials - Learn Server-Side Programming')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            <div class="inline-flex items-center justify-center w-16 h-16 bg-purple-100 dark:bg-purple-900 rounded-full mb-4">
                <i class="fab fa-php text-3xl text-purple-600 dark:text-purple-400"></i>
            </div>
            <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">
                PHP Tutorials
            </h1>
            <p class="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Master PHP - the powerful server-side scripting language that powers 79% of the web. 
                Learn to build dynamic websites, APIs, and robust backend systems.
            </p>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm border border-gray-100 dark:border-gray-700">
                <div class="text-2xl font-bold text-orange-600 dark:text-orange-400 mb-2">79% Web</div>
                <div class="text-sm text-gray-600 dark:text-gray-400">Market Share</div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 mb-12">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div class="text-center group">
                    ...
                    <h3 class="font-semibold text-gray-900 dark:text-white text-sm">Server-Side</h3>
                </div>
                <div class="text-center group">
                    ...
                    <h3 class="font-semibold text-gray-900 dark:text-white text-sm">Database</h3>
                </div>
                <div class="text-center group">
                    <div class="w-16 h-16 bg-purple-100 dark:bg-purple-900 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300">
                        <i class="fas fa-shield-alt text-xl text-purple-600 dark:text-purple-400"></i>
                    </div>
                    <h3 class="font-semibold text-gray-900 dark:text-white text-sm">Security</h3>
                </div>
                <div class="text-center group">
                    <div class="w-16 h-16 bg-orange-100 dark:bg-orange-900 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300">
                        <i class="fas fa-rocket text-xl text-orange-600 dark:text-orange-400"></i>
                    </div>
                    <h3 class="font-semibold text-gray-900 dark:text-white text-sm">Performance</h3>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 mb-12">
            <div class="text-center max-w-3xl mx-auto">
                <div class="w-16 h-16 bg-gradient-to-r from-purple-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-6">
                ...
                <p class="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                    Write, test, and run PHP code directly in your browser with these online sandboxes and IDEs.
                </p>
                    ...
                    <a href="https://phpsandbox.io/" target="_blank" rel="noopener noreferrer"
                       class="group bg-gradient-to-r from-purple-600 to-purple-700 text-white p-6 rounded-xl hover:from-purple-700 hover:to-purple-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div class="text-center">
                            ...
                            <h3 class="font-semibold text-lg mb-2">PHP Sandbox</h3>
                            <p class="text-purple-100 text-sm opacity-90">Online IDE</p>
                        </div>
                    </a>
                    
                    <a href="https://3v4l.org/" target="_blank" rel="noopener noreferrer"
                       class="group bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div class="text-center">
                            ...
                            <h3 class="font-semibold text-lg mb-2">3v4l</h3>
                            <p class="text-blue-100 text-sm opacity-90">Multi-Version</p>
                        </div>
                    </a>
                    
                    <a href="https://replit.com/languages/php" target="_blank" rel="noopener noreferrer"
                       class="group bg-gradient-to-r from-green-600 to-green-700 text-white p-6 rounded-xl hover:from-green-700 hover:to-green-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div class="text-center">
                            ...
                            <p class="text-green-100 text-sm opacity-90">Full Environment</p>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="bg-gradient-to-r from-purple-600 to-red-600 rounded-2xl p-8 text-white mb-12">
            <div class="text-center max-w-3xl mx-auto">
                <h2 class="text-3xl font-bold mb-4">Advance Your PHP Skills</h2>
                <p class="text-purple-100 text-lg mb-8">
                    Build upon your PHP foundation with modern frameworks and advanced backend development.
                </p>
