...
@section('title', 'jQuery Tutorials - Learn DOM Manipulation')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            <div class="inline-flex items-center justify-center w-16 h-16 bg-blue-100 dark:bg-blue-900 rounded-full mb-4">
                <i class="fab fa-js-square text-3xl text-blue-600 dark:text-blue-400"></i>
            </div>
            <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">
                jQuery Tutorials
            </h1>
            <p class="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Master jQuery - the legendary JavaScript library that revolutionized web development. 
                Learn DOM manipulation, event handling, animations, and AJAX with simple, powerful syntax.
            </p>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm border border-gray-100 dark:border-gray-700">
                <div class="text-2xl font-bold text-orange-600 dark:text-orange-400 mb-2">Legacy</div>
                <div class="text-sm text-gray-600 dark:text-gray-400">Widely Used</div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div class="text-center group">
                    <div class="w-16 h-16 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300">
                        <i class="fas fa-mouse-pointer text-xl text-blue-600 dark:text-blue-400"></i>
                    </div>
                    <h3 class="font-semibold text-gray-900 dark:text-white text-sm">DOM Selection</h3>
                </div>
                <div class="text-center group">
                    ...
                    <h3 class="font-semibold text-gray-900 dark:text-white text-sm">Event Handling</h3>
                </div>
                <div class="text-center group">
                    <div class="w-16 h-16 bg-purple-100 dark:bg-purple-900 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300">
                        <i class="fas fa-spinner text-xl text-purple-600 dark:text-purple-400"></i>
                    </div>
                    <h3 class="font-semibold text-gray-900 dark:text-white text-sm">Animations</h3>
                </div>
                <div class="text-center group">
                    <div class="w-16 h-16 bg-orange-100 dark:bg-orange-900 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300">
                        <i class="fas fa-exchange-alt text-xl text-orange-600 dark:text-orange-400"></i>
                    </div>
                    <h3 class="font-semibold text-gray-900 dark:text-white text-sm">AJAX</h3>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 mb-12">
            <div class="text-center max-w-3xl mx-auto">
                <div class="w-16 h-16 bg-gradient-to-r from-blue-500 to-green-600 rounded-full flex items-center justify-center mx-auto mb-6">
                    <i class="fas fa-code text-2xl text-white"></i>
                </div>
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">
                    Practice jQuery Live
                </h2>
                <p class="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                    Experiment with jQuery selectors, animations, and AJAX calls in real-time with these online playgrounds.
                </p>
                    ...
                    <a href="https://jsfiddle.net/" target="_blank" rel="noopener noreferrer"
                       class="group bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div class="text-center">
                            ...
                            <p class="text-blue-100 text-sm opacity-90">Quick Testing</p>
                        </div>
                    </a>
                    ...
                    <a href="https://codepen.io/pen/" target="_blank" rel="noopener noreferrer"
                       class="group bg-gradient-to-r from-green-600 to-green-700 text-white p-6 rounded-xl hover:from-green-700 hover:to-green-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div class="text-center">
                            ...
                            <p class="text-green-100 text-sm opacity-90">Creative Coding</p>
                        </div>
                    </a>
                    ...
                    <a href="https://jsbin.com/" target="_blank" rel="noopener noreferrer"
                       class="group bg-gradient-to-r from-purple-600 to-purple-700 text-white p-6 rounded-xl hover:from-purple-700 hover:to-purple-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div class="text-center">
                            ...
                            <h3 class="font-semibold text-lg mb-2">JSBin</h3>
                            <p class="text-purple-100 text-sm opacity-90">Simple Editor</p>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="bg-gradient-to-r from-blue-600 to-green-600 rounded-2xl p-8 text-white mb-12">
            <div class="text-center max-w-3xl mx-auto">
                <h2 class="text-3xl font-bold mb-4">Modern JavaScript Path</h2>
                <p class="text-blue-100 text-lg mb-8">
                    While jQuery is great for legacy projects, modern development uses vanilla JavaScript and frameworks.
                </p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <div class="text-center">
                    ...
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-2">Official Documentation</h3>
                ...
                <div class="text-center">
                    ...
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-2">Plugin Library</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                        Thousands of plugins for extended functionality
                    </p>
                    <a href="https://plugins.jquery.com/" target="_blank" 
                       class="inline-flex items-center text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300">
                        Browse Plugins <i class="fas fa-arrow-right ml-2"></i>
                    </a>
                </div>
            </div>
        </div>
