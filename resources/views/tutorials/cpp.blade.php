...
@section('title', 'C++ Tutorials - Learn Systems Programming')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Master high-performance programming with C++. Learn systems programming, 
                memory management, and advanced algorithms for game development and applications.
            </p>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm border border-gray-100 dark:border-gray-700">
                <div class="text-2xl font-bold text-orange-600 dark:text-orange-400 mb-2">Advanced</div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm border border-gray-100 dark:border-gray-700">
                <div class="text-2xl font-bold text-red-600 dark:text-red-400 mb-2">Performance</div>
                <div class="text-sm text-gray-600 dark:text-gray-400">Speed Focus</div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 mb-12">
            <div class="text-center max-w-3xl mx-auto">
                ...
                <p class="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                    Write, compile, and run C++ code directly in your browser with these online compilers.
                </p>
                    ...
                    <a href="https://www.onlinegdb.com/online_c++_compiler" target="_blank" rel="noopener noreferrer"
                       class="group bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div class="text-center">
                            ...
                            <h3 class="font-semibold text-lg mb-2">OnlineGDB</h3>
                            <p class="text-blue-100 text-sm opacity-90">Debugger Included</p>
                        </div>
                    </a>
                    
                    <a href="https://replit.com/languages/cpp" target="_blank" rel="noopener noreferrer"
                       class="group bg-gradient-to-r from-green-600 to-green-700 text-white p-6 rounded-xl hover:from-green-700 hover:to-green-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div class="text-center">
                            ...
                            <p class="text-green-100 text-sm opacity-90">Full IDE</p>
                        </div>
                    </a>
                    
                    <a href="https://www.programiz.com/cpp-programming/online-compiler/" target="_blank" rel="noopener noreferrer"
                       class="group bg-gradient-to-r from-purple-600 to-purple-700 text-white p-6 rounded-xl hover:from-purple-700 hover:to-purple-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div class="text-center">
                            ...
                            <p class="text-purple-100 text-sm opacity-90">Fast Compiler</p>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white mb-12">
            <div class="text-center max-w-3xl mx-auto">
                <h2 class="text-3xl font-bold mb-4">Advance Your Systems Programming Skills</h2>
                <p class="text-blue-100 text-lg mb-8">
                    Build upon your C++ knowledge with these advanced topics and related technologies.
                </p>
