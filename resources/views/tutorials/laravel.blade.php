...
@section('title', 'Laravel Tutorials - Learn PHP Framework')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            <div class="inline-flex items-center justify-center w-16 h-16 bg-red-100 dark:bg-red-900 rounded-full mb-4">
                <i class="fab fa-laravel text-3xl text-red-600 dark:text-red-400"></i>
            </div>
            <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">
                Laravel Tutorials
            </h1>
            <p class="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Master Laravel - the elegant PHP framework for building modern web applications. 
                Learn routing, Eloquent ORM, authentication, and build robust, scalable applications.
            </p>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm border border-gray-100 dark:border-gray-700">
                <div class="text-2xl font-bold text-purple-600 dark:text-purple-400 mb-2">MVC</div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 mb-12">
            <div class="text-center max-w-3xl mx-auto">
                ...
                <p class="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                    Explore Laravel-specific tools and playgrounds to practice and experiment with the framework.
                </p>
                    ...
                    <a href="https://laravelplayground.com/" target="_blank" rel="noopener noreferrer"
                       class="group bg-gradient-to-r from-red-600 to-red-700 text-white p-6 rounded-xl hover:from-red-700 hover:to-red-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div class="text-center">
                            ...
                            <h3 class="font-semibold text-lg mb-2">Laravel Playground</h3>
                            <p class="text-red-100 text-sm opacity-90">Online Sandbox</p>
                        </div>
                    </a>
                    
                    <a href="https://tinkerwell.app/" target="_blank" rel="noopener noreferrer"
                       class="group bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div class="text-center">
                            ...
                            <h3 class="font-semibold text-lg mb-2">Tinkerwell</h3>
                            <p class="text-blue-100 text-sm opacity-90">Desktop App</p>
                        </div>
                    </a>
                    ...
                    <a href="https://laravel.com/docs" target="_blank" rel="noopener noreferrer"
                       class="group bg-gradient-to-r from-green-600 to-green-700 text-white p-6 rounded-xl hover:from-green-700 hover:to-green-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div class="text-center">
                            ...
                            <p class="text-green-100 text-sm opacity-90">Official Docs</p>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="bg-gradient-to-r from-red-600 to-purple-600 rounded-2xl p-8 text-white mb-12">
            <div class="text-center max-w-3xl mx-auto">
                <h2 class="text-3xl font-bold mb-4">Full-Stack Development Path</h2>
                <p class="text-red-100 text-lg mb-8">
                    Combine Laravel with frontend technologies to build complete full-stack applications.
                </p>
